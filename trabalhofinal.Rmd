...
### Regressão 2, com a variável de limitação como dependente

```{r}
regressao2 <- lm (salario ~ limita + idade + sexo + trabalho + escolaridade + renda_domiciliar + cor + regiao, data = filtrado_idade)
summary(regressao2)
confint(regressao2)
...
regressao3 <- lm (salario ~ limita + idade + sexo + trabalho + escolaridade + renda_domiciliar + cor + regiao, data = sem_outlier2)
summary(regressao3)
